...
comments: true
excerpt: "Java Sınıf Deklarasyonu ve Değiştiriciler"
header:
...
<figure >
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/f0024-01.jpg" alt="interface example">
...
<figure >
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/interface1.png" alt="interface example">
...
<figure >
  <img src="{{ site.url }}{{ site.baseurl }}/assets/images/interface2.png" alt="interface example">
  <figcaption>Intellij Idea Ide'sinden ekran görüntüsü</figcaption>
</figure>
